export const random_words = [
    ...
    'guitar', 'piano', 'violin', 'drums', 'trumpet', 'flute', 'saxophone', 'clarinet', 'harp', 'banjo',
    'book', 'newspaper', 'magazine', 'dictionary', 'encyclopedia', 'novel', 'poem', 'comic', 'journal', 'notebook',
    'chair', 'table', 'sofa', 'bed', 'wardrobe', 'desk', 'lamp', 'mirror', 'rug', 'cushion',
    'sun', 'moon', 'star', 'planet', 'galaxy', 'meteor', 'comet', 'constellation', 'eclipse', 'astronaut'
]